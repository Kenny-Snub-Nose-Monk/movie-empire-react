...
## Description
  WatchMe Movie WebSite uses TMDB API to provide the latest move information. You can search any movie easily and add them to your favorite or watch list. One big point for this project is included [Alan AI](https://alan.app/) which is NLP (Nautral Lanugage Processing) function. You can try to use your voice to search the movie or make fun.
  Try to do below :
